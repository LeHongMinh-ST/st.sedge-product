    ...
    <form action="https://spacingtech.com/cart" method="post" class="drawer-contents">
        ...
        <div class="drawer-cart-empty">
            <div class="drawer-scrollable">
                ...
                <a href="https://spacingtech.com/collections/all" class="btn btn-style2">Qauy trở lại cửa hàng</a>
            </div>
        </div>
        <div class="drawer-inner">
                ...
                <ul class="cart-items">
                        ...
                        <div class="cart-item-info">
                            <div class="cart-item-image">
                                <a href="product-template.html">
                                    <img src="{{asset('assets/client/img/cart/home-cart1.jpg')}}" class="img-fluid" alt="cart-1">
                                </a>
                            </div>
                            <div class="cart-item-details">
                                ...
                                <div class="cart-pro-info">
                                    <div class="cart-qty-price">
                                        <span>1</span>
                                        <span>×</span>
                                        <span class="price">125.000 <u>đ</u></span>
                                    </div>
                                </div>
                                <div class="cart-item-sub">
                                    <div class="cart-qty-price-remove">
                                        ...
                                        <div class="cart-item-price">
                                            <span class="cart-price">12.000 <u>đ</u></span>
                                        </div>
                    ...
                    <li class="cart-item">
                        <div class="cart-item-info">
                            <div class="cart-item-image">
                                <a href="product-template.html">
                                    <img src="{{asset('assets/client/img/cart/home-cart2.jpg')}}" class="img-fluid" alt="cart-2">
                                </a>
                            </div>
                            <div class="cart-item-details">
                                <div class="cart-item-name">
                                ...
                                <div class="cart-pro-info">
                                    <div class="cart-qty-price">
                                        <span>2</span>
                                        <span>×</span>
                                        <span class="price">190.000 <u>đ</u></span>
                                    </div>
                                </div>
                                <div class="cart-item-sub">
                                    <div class="cart-qty-price-remove">
                    ...
                    {{-- <li class="cart-item">
                        <div class="cart-item-info">
                            <div class="cart-item-image">
                                <a href="product-template.html">
                                    <img src="{{asset('assets/client/img/cart/home-cart3.jpg')}}" class="img-fluid" alt="cart-3">
                                </a>
                            </div>
                            <div class="cart-item-details">
                                <div class="cart-item-name">
                    ...
                    <li class="cart-item">
                        <div class="cart-item-info">
                            <div class="cart-item-image">
                                <a href="product-template.html">
                                    <img src="{{asset('assets/client/img/cart/home-cart4.jpg')}}" class="img-fluid" alt="cart-4">
                                </a>
                            </div>
                            <div class="cart-item-details">
                                <div class="cart-item-name">
                    ...
                    <li class="cart-item">
                        <div class="cart-item-info">
                            <div class="cart-item-image">
                                <a href="product-template.html">
                                    <img src="{{asset('assets/client/img/cart/home-cart5.jpg')}}" class="img-fluid" alt="cart-5">
                                </a>
                            </div>
                            <div class="cart-item-details">
                                <div class="cart-item-name">
            ...
            <div class="drawer-footer">
                <div class="drawer-block drawer-total">
                    ...
                    <span class="drawer-totalprice">304.000 <u>đ</u></span>
                </div>
                <div class="drawer-block drawer-ship-text">
                    <label class="box-area">
                        <span class="text">Tôi đã đọc và đồng ý với <a href="terms-condition.html"> điều khoản &amp; điều kiện.</a></span>
